              ...
              <div className="ms-lg-4">
                <div className="section-title">
                  ...
                  <p className="text-muted para-desc">
                    Start working with{' '}
                    <span className="text-primary fw-bold">SmartP</span> can
                    lead to greater efficiency in hiring process.
                  </p>
                  <p className="text-muted para-desc mb-0">
                    Our platform is developed to improve the efficiency in the
                    recruitment process, facilitating the experience for both
                    parties and generating a higher rate of hiring highly
                ...
                <div className="d-flex mt-4 pt-2">
                  ...
                  <div className="flex-1 ms-2">
                    ...
                    <p className="mb-0 text-muted">
                      You just have to register and add linkedin and github
                      profile, we take care of the rest. Even if this is not
                      enough or you are not satisfied, you can still edit your
                      profile.
                    </p>
                  </div>
                </div>
                ...
                <div className="d-flex mt-4 pt-2">
                  ...
                  <div className="flex-1 ms-2">
                    <h5>Job Board</h5>
                    <p className="mb-0 text-muted">
                      Access our job offers, with a clear, detailed process and
                      a notification system for each step you take, so as not to
                      leave you alone at any time.
                    </p>
                  </div>
                </div>
